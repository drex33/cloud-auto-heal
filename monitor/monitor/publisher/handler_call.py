...
# 메시지 전송 데이터 설정
compute_messages = [
    {"exchange": "cloud-auto-heal.compute", "routing_key": "cloud.auto.heal.compute", "payload": "libvirt_suspend_wakeup"}
]

control_messages = [
    {"exchange": "cloud-auto-heal.control", "routing_key": "cloud.auto.heal.control", "payload": "allocation_heal"}
]
